...
curl -X GET http://localhost:10001/stats/kienboec --header "Authorization: Basic kienboec-sebToken"
echo.
curl -X GET http://localhost:10001/stats/altenhof --header "Authorization: Basic altenhof-sebToken"
echo.
echo.
...
curl -X GET http://localhost:10001/history/kienboec --header "Authorization: Basic kienboec-sebToken"
echo.
curl -X GET http://localhost:10001/history/altenhof --header "Authorization: Basic altenhof-sebToken"
echo.
echo.
...
curl -X POST http://localhost:10001/history/kienboec --header "Content-Type: application/json" --header "Authorization: Basic kienboec-sebToken" -d "{\"Name\": \"PushUps\",  \"Count\": 40, \"Duration\": 60}"
echo.
curl -X POST http://localhost:10001/history/altenhof --header "Content-Type: application/json" --header "Authorization: Basic altenhof-sebToken" -d "{\"Name\": \"PushUps\",  \"Count\": 50, \"Duration\": 70}"
echo.
echo.
...
curl -X POST http://localhost:10001/history/kienboec --header "Content-Type: application/json" --header "Authorization: Basic kienboec-sebToken" -d "{\"Name\": \"PushUps\",  \"Count\": 11, \"Duration\": 25}"
echo.
echo.
...
REM --------------------------------------------------
echo 20) Make Handstand and add ELO
curl -X POST http://localhost:10001/extra/kienboec --header "Content-Type: application/json" --header "Authorization: Basic kienboec-sebToken" -d "{\"Name\": \"Handstand\",  \"Count\": 5}"
echo.
echo.
curl -X GET http://localhost:10001/stats/kienboec --header "Authorization: Basic kienboec-sebToken"
